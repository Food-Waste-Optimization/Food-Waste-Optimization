...
class DataRepository:
    ...
    def get_df_from_stationary_data(self):
        ...
        customer_data = self.merge_multiple_excel_sheets("../data/basic_mvp_data/kumpula_data.xlsx")
        
        # Get people flow data by date
        supersight_data = self.get_people_flow_by_date("../data/basic_mvp_data/supersight-raw-data.csv")
