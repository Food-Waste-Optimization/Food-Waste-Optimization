      ...
      <div className="flex flex-col md:flex-row container mx-auto p-3 mt-12">
        <div className="flex-1 md:mr-5 mb-10 max-w-lg">
          ...
          <p className="text-lg mb-4 py-3">
            Sustainable recommendation system designed to suggest optimal menus
            for any date and location at Kumpula campus. The system predicts
            sales, biowaste, and carbon emission levels. Leverage these insights
            to refine your meal plans and optimize your results for improved
            sustainability.
          </p>
        ...
        <div className="flex-1 px-8">
          <img src={vegetables} className="w-full h-auto" />
        </div>
      </div>
    </>
  );
